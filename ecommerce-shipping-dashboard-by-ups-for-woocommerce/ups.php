 ...
 */
define( 'UPS_VERSION', '1.0.5' );

/*
* Define global vraibles
*/
define( 'UPS_TEXTDOMAIN', 'ups' );
...
define(
	...
	'https://api.itembase.com/connectivity/instances/' . UPS_ITEMBASE_INSTANCE_ID . '/connect/complete'
);
...
/**
 * Summary of ups_before_woocommerce_init this function check compatibility.
 *
 * @since 1.0.5
 * @return void
 */
